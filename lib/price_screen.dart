...
class _PriceScreenState extends State<PriceScreen> {
  ...
  void updateUI({dynamic coindata, String selectedCurrency}) async {
    ...
    for (String crypto in cryptoList) {
      var apiData =
          await coindata.getData(currency: selectedCurrency, crypto: crypto);
  ...
  @override
  void initState() {
    updateUI(coindata: coindata, selectedCurrency: 'USD');
    super.initState();
  }
  @override
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          ...
          children: <Widget>[
            getCryptoCoinPadding(
                crypto: 'BTC', currencyValue: selectedCurrencyValueforBTC.data),
            getCryptoCoinPadding(
                crypto: 'ETH', currencyValue: selectedCurrencyValueforETH.data),
            getCryptoCoinPadding(
                crypto: 'LTC', currencyValue: selectedCurrencyValueforLTC.data),
            Expanded(
              child: Align(
